...
public class PlayerPanel extends JPanel {
    ...
    public PlayerPanel(PlayerController playerController) {
        ...
        nameLabel = new JLabel("Player : " + playerController.getPlayer().getName());
        levelLabel = new JLabel("Level : " + playerController.getPlayer().getLevel());
    ...
    public void refresh() {
        nameLabel.setText("Player : " + playerController.getPlayer().getName());
        levelLabel.setText("Level : " + playerController.getPlayer().getLevel());
